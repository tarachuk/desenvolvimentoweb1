...
function atualizarLivro() {
    ...
    const id = readline.question("Digite o ID do livro: ");
    const tituo = readline.question("Digite o titulo novo do livro: ");
    const autor = readline.question("Digite o novo autor: ");
    ...
    WHERE id = ?
    `;
    conexao.query(update, [tituo, autor, id], function (erro, resultado) {
