...
function atualizarProduto() {
    ...
    const id = readline.question("Digite o ID do produto: ");
    const nome = readline.question("Digite o nome novo do produto: ");
    const preco = readline.question("Digite o novo preço: ");
    const quantidade = readline.question("Digite a nova quantidade: ");
